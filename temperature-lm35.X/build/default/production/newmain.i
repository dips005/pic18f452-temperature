...
void UART_Init(int baudrate)
{
   ...
   TXSTA &=~(1<<4);
   RCSTA |=(1<<7);
   SPBRG=(unsigned char)((8000000UL/(16*(unsigned long)(baudrate)))-1);
}
...
void UART_SendIntToString(int data,char numberOfDigits)
{
    ...
    {
        h_val=data/(powf(10,i));
        UART_SendChar(h_val+48);
        data=data-(h_val*(powf(10,i)));
    }
...
void UART_SendFloatToString(float val, char numberOfDigits,char decPoints)
{
    ...
    int int_val=val;
    int dec_val=((float)val-(float)int_val)*powf(10,decPoints);

    char h_val;
    for(char i=(numberOfDigits-1);i>=1;i--)
    {
        h_val=int_val/(powf(10,i));
        UART_SendChar(h_val+48);
        int_val-=(h_val*(powf(10,i)));
    }
    ...
    {
        h_val=dec_val/(powf(10,i));
        UART_SendChar(h_val+48);
        dec_val-=(h_val*(powf(10,i)));
    }
...
void __attribute__((picinterrupt(("low_priority")))) my_low_priority_isr_routine (void) {
}

void __attribute__((picinterrupt(("high_priority")))) my_high_priority_isr_routine (void) {
}
